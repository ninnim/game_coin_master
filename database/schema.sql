-- =============================================================
-- Spin Empire — Full PostgreSQL Schema
...
-- =============================================================
-- Add self-referencing FK for active_pet_id after pets table exists
-- (done via user_pets.is_active instead; active_pet_id stores pet_id)
-- =============================================================
